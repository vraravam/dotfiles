...
```zsh
export GH_USERNAME="vraravam" DOTFILES_BRANCH="rename-bin-oss" HOMEBREW_BASE_INSTALL="true"; curl -fsSL "https://raw.githubusercontent.com/${GH_USERNAME}/dotfiles/refs/heads/${DOTFILES_BRANCH}/scripts/fresh-install-of-osx.sh" | zsh
```
