...
4. If you use Raycast, you can enable the 'Export Settings & Data' option in the Raycast Preferences, and back-up that exported file so as to use it to resurrect into the new machine.
