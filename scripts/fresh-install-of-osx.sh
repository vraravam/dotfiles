...
sh -c "HOMEBREW_BASE_INSTALL=true ${HOMEBREW_PREFIX}/bin/brew bundle check --file '${HOME}/Brewfile' || ${HOMEBREW_PREFIX}/bin/brew bundle --file '${HOME}/Brewfile' &> /dev/null 2>&1 || true"
