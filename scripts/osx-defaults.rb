...
system('sudo', '-v') unless ScriptMode.auto?
...
if _ask('Restart automatically if the computer freezes', 'Y')
  ...
  CommandUtils.run_silent('sudo', 'systemsetup', '-setrestartfreeze', 'on', err: :err)
end

CommandUtils.run_silent('sudo', 'systemsetup', '-settimezone', 'Asia/Calcutta', err: :err) if _ask('Set the timezone to Asia/Calcutta', 'Y')

CommandUtils.run_silent('sudo', 'systemsetup', '-setusingnetworktime', 'on', err: :err) if _ask('Sync time automatically using network time servers', 'Y')

CommandUtils.run_silent('sudo', 'systemsetup', '-setcomputersleep', '10', err: :err) if _ask('Set the computer sleep time to 10 minutes', 'Y')

CommandUtils.run_silent('sudo', 'systemsetup', '-setdisplaysleep', '10', err: :err) if _ask('Set the display sleep time to 10 minutes', 'Y')

CommandUtils.run_silent('sudo', 'systemsetup', '-setharddisksleep', '15', err: :err) if _ask('Set the hard disk sleep time to 15 minutes', 'Y')
...
if _ask('Set preferred languages to English (India, US) and clear recent places', 'Y')
  ...
  CommandUtils.run_silent('defaults', 'delete', 'NSGlobalDomain', 'NSNavRecentPlaces', err: :err)
end
...
if _ask('iTerm2 settings', 'Y')
  ...
  _pbd("Delete :'New Bookmarks':0:'Custom Directory'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Custom Directory' string Recycle", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Enable Progress Bars'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Enable Progress Bars' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Show Status Bar'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Show Status Bar' bool true", ITERM_PLIST)
  ...
  # Profiles > Text
  _pbd("Delete :'New Bookmarks':0:'ASCII Anti Aliased'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'ASCII Anti Aliased' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Allow Title Setting'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Allow Title Setting' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Ambiguous Double Width'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Ambiguous Double Width' bool false", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Background Image Location'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Background Image Location' string ''", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Blinking Cursor'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Blinking Cursor' bool false", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Blur'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Blur' bool false", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Draw Powerline Glyphs'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Draw Powerline Glyphs' bool true", ITERM_PLIST)
  # Horizontal and Vertical Spacing: multipliers relative to font's natural spacing (1.0 = default).
  _pbd("Delete :'New Bookmarks':0:'Horizontal Spacing'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Horizontal Spacing' real 1", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Non Ascii Font'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Non Ascii Font' string 'Monaco 12'", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Non-ASCII Anti Aliased'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Non-ASCII Anti Aliased' bool true", ITERM_PLIST)
  # Keeps background color opaque when transparency > 0; only cursor/text area is affected.
  _pbd("Delete :'New Bookmarks':0:'Only The Default BG Color Uses Transparency'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Only The Default BG Color Uses Transparency' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Transparency'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Transparency' real 0", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Use Bold Font'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Use Bold Font' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Use Bright Bold'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Use Bright Bold' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Use Italic Font'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Use Italic Font' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Use Non-ASCII Font'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Use Non-ASCII Font' bool false", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Vertical Spacing'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Vertical Spacing' real 1", ITERM_PLIST)

  # Profiles > Terminal
  # 4 = UTF-8 encoding.
  _pbd("Delete :'New Bookmarks':0:'Character Encoding'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Character Encoding' integer 4", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Custom Locale'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Custom Locale' string 'en_US.UTF-8'", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Disable Printing'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Disable Printing' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Idle Code'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Idle Code' integer 0", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Load Shell Integration Automatically'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Load Shell Integration Automatically' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Mouse Reporting'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Mouse Reporting' bool true", ITERM_PLIST)
  # 0 scrollback lines with Unlimited Scrollback = true means no hard cap.
  _pbd("Delete :'New Bookmarks':0:'Scrollback Lines'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Scrollback Lines' integer 0", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Send Code When Idle'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Send Code When Idle' bool false", ITERM_PLIST)
  # 2 = set locale environment variables automatically.
  _pbd("Delete :'New Bookmarks':0:'Set Local Environment Vars'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Set Local Environment Vars' integer 2", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Terminal Type'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Terminal Type' string 'xterm-256color'", ITERM_PLIST)

  # Profiles > Window
  _pbd("Delete :'New Bookmarks':0:'Disable Window Resizing'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Disable Window Resizing' bool true", ITERM_PLIST)
  # 1 = use profile name as window/tab icon label.
  _pbd("Delete :'New Bookmarks':0:Icon", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:Icon integer 1", ITERM_PLIST)
  # -1 = open new sessions on the screen the window is currently on.
  _pbd("Delete :'New Bookmarks':0:Screen", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:Screen integer -1", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Sync Title'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Sync Title' bool false", ITERM_PLIST)
  # 1 = show profile name as the title component.
  _pbd("Delete :'New Bookmarks':0:'Title Components'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Title Components' integer 1", ITERM_PLIST)
  # 0 = normal (non-fullscreen, non-maximized) window type.
  _pbd("Delete :'New Bookmarks':0:'Window Type'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Window Type' integer 0", ITERM_PLIST)

  # Profiles > General / Session
  # BM Growl: post a notification-center alert when bell fires in a background tab.
  _pbd("Delete :'New Bookmarks':0:'BM Growl'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'BM Growl' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Close Sessions On End'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Close Sessions On End' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:Command", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:Command string ''", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Custom Tab Title'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Custom Tab Title' string ''", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Default Bookmark'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Default Bookmark' string 'No'", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:Description", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:Description string 'Default'", ITERM_PLIST)
  # Flashing Bell: flash the screen on bell (distinct from Visual Bell which uses a badge).
  _pbd("Delete :'New Bookmarks':0:'Flashing Bell'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Flashing Bell' bool true", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:Name", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:Name string 'Default'", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Open Toolbelt'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Open Toolbelt' bool false", ITERM_PLIST)
  # 2 = always prompt before closing if a job other than those in 'Jobs to Ignore' is running.
  _pbd("Delete :'New Bookmarks':0:'Prompt Before Closing 2'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Prompt Before Closing 2' integer 2", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:Shortcut", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:Shortcut string ''", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Use Custom Tab Title'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Use Custom Tab Title' bool false", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Working Directory'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Working Directory' string '#{EnvVars::HOME}'", ITERM_PLIST)
  ...
  _pbd("Delete :'New Bookmarks':0:'Option Key Sends'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Option Key Sends' integer 0", ITERM_PLIST)
  _pbd("Delete :'New Bookmarks':0:'Right Option Key Sends'", ITERM_PLIST)
  _pb("Add :'New Bookmarks':0:'Right Option Key Sends' integer 0", ITERM_PLIST)
end
...
CommandUtils.run_silent('sudo', 'mdutil', '-Eda')
CommandUtils.run_silent('sudo', 'mdutil', '-ai', 'off')
